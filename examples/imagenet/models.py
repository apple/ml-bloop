...
class ResNet(nn.Module):
    ...
    @nn.compact
    def __call__(self, x, train: bool = True, branch="main"):
...
# Used to get pretrained teach model
def load_pretrained_resnest(size=50):
    from jax_resnet import pretrained_resnest

    ResNeSt, variables = pretrained_resnest(size)
    return ResNeSt(), variables
